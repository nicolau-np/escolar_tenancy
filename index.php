...
<html lang="en">
    <head>
        <title>2k19 Moon - Sistema de Gestão Escolar</title>
        <meta charset="utf-8">
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#form_consulta").submit(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "z_controls/consultar_nota.php",
                        data: dados,
                        success: function (resposta) {
                            $("#carregar_notas").text('').append(resposta);
    ...
    <body>
        ...
        <section class="home-slider owl-carousel">
            <div class="slider-item" style="background-image:url(CLIENTE_ACTIVOS/images/bg_1.jpg);">
                <div class="overlay"></div>
                <div class="container">
                    <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
                        <div class="col-md-8 text-center ftco-animate">
                            <h1 class="mb-4">As crianças são os melhores exploradores do mundo</h1>
                            <p><a href="#" class="btn btn-secondary px-4 py-3 mt-3">Mais informação</a></p>
                        </div>
                    </div>
                </div>
            </div>

            <div class="slider-item" style="background-image:url(CLIENTE_ACTIVOS/images/bg_2.jpg);">
                <div class="overlay"></div>
                <div class="container">
                    <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
                        <div class="col-md-8 text-center ftco-animate">
                            <h1 class="mb-4">Perfeito aprendizado <span>para o seu filho</span></h1>
                            <p><a href="#" class="btn btn-secondary px-4 py-3 mt-3">Mais informação</a></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row no-gutters">
                    <div class="col-md-3 d-flex services align-self-stretch pb-4 px-4 ftco-animate bg-primary">
                        <div class="media block-6 d-block text-center">
                            ...
                            <div class="media-body p-2 mt-3">
                                <h3 class="heading">Professores certificados</h3>
                    ...
                    <div class="col-md-3 d-flex services align-self-stretch pb-4 px-4 ftco-animate bg-tertiary">
                        <div class="media block-6 d-block text-center">
                            ...
                            <div class="media-body p-2 mt-3">
                                <h3 class="heading">Educação especial</h3>
                                <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p>
                            </div>
                        </div>    
                    </div>
                    <div class="col-md-3 d-flex services align-self-stretch pb-4 px-4 ftco-animate bg-fifth">
                        <div class="media block-6 d-block text-center">
                            ...
                            <div class="media-body p-2 mt-3">
                                <h3 class="heading">Livro &amp; Biblioteca</h3>
                                <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p>
                            </div>
                        </div>      
                    </div>
                    <div class="col-md-3 d-flex services align-self-stretch pb-4 px-4 ftco-animate bg-quarternary">
                        <div class="media block-6 d-block text-center">
                            ...
                            <div class="media-body p-2 mt-3">
                                <h3 class="heading">Certificação</h3>
                                <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p>
                            </div>
                        </div>      
                    </div>
        ...
        <section class="ftco-intro" style="background-image: url(CLIENTE_ACTIVOS/images/bg_3.jpg);" data-stellar-background-ratio="0.5">
            <div class="overlay"></div>
            <div class="container">
                <div class="row">
                    <div class="col-md-9">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="staff">
                            <div class="img-wrap d-flex align-items-stretch">
                                <div class="img align-self-stretch" style="background-image: url(CLIENTE_ACTIVOS/images/teacher-1.jpg);"></div>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="staff">
                            <div class="img-wrap d-flex align-items-stretch">
                                <div class="img align-self-stretch" style="background-image: url(CLIENTE_ACTIVOS/images/teacher-2.jpg);"></div>
                            </div>
                            <div class="text pt-3 text-center">
                                <h3>Mitch Parker</h3>
                    ...
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="staff">
                            <div class="img-wrap d-flex align-items-stretch">
                                <div class="img align-self-stretch" style="background-image: url(CLIENTE_ACTIVOS/images/teacher-3.jpg);"></div>
                            </div>
                            <div class="text pt-3 text-center">
                                <h3>Stella Smith</h3>
                    ...
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="staff">
                            <div class="img-wrap d-flex align-items-stretch">
                                <div class="img align-self-stretch" style="background-image: url(CLIENTE_ACTIVOS/images/teacher-4.jpg);"></div>
                            </div>
                            <div class="text pt-3 text-center">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 course d-lg-flex ftco-animate">
                        <div class="img" style="background-image: url(CLIENTE_ACTIVOS/images/course-1.jpg);"></div>
                    ...
                    <div class="col-md-6 course d-lg-flex ftco-animate">
                        <div class="img" style="background-image: url(CLIENTE_ACTIVOS/images/course-2.jpg);"></div>
                        <div class="text bg-light p-4">
                    ...
                    <div class="col-md-6 course d-lg-flex ftco-animate">
                        <div class="img" style="background-image: url(CLIENTE_ACTIVOS/images/course-3.jpg);"></div>
                        <div class="text bg-light p-4">
                    ...
                    <div class="col-md-6 course d-lg-flex ftco-animate">
                        <div class="img" style="background-image: url(CLIENTE_ACTIVOS/images/course-4.jpg);"></div>
                        <div class="text bg-light p-4">
        ...
        <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(CLIENTE_ACTIVOS/images/bg_4.jpg);" data-stellar-background-ratio="0.5">
            <div class="container">
                <div class="row justify-content-center mb-5 pb-2">
                        ...
                        <div class="carousel-testimony owl-carousel">
                            <div class="item">
                                <div class="testimony-wrap d-flex">
                                    <div class="user-img mr-4" style="background-image: url(CLIENTE_ACTIVOS/images/teacher-1.jpg)">
                                    </div>
                            ...
                            <div class="item">
                                <div class="testimony-wrap d-flex">
                                    <div class="user-img mr-4" style="background-image: url(CLIENTE_ACTIVOS/images/teacher-2.jpg)">
                                    </div>
                                    <div class="text ml-2 bg-light">
                                        <span class="quote d-flex align-items-center justify-content-center">
                                            <i class="icon-quote-left"></i>
                            ...
                            <div class="item">
                                <div class="testimony-wrap d-flex">
                                    <div class="user-img mr-4" style="background-image: url(CLIENTE_ACTIVOS/images/teacher-3.jpg)">
                                    </div>
                                    <div class="text ml-2 bg-light">
                                        <span class="quote d-flex align-items-center justify-content-center">
                                            <i class="icon-quote-left"></i>
                            ...
                            <div class="item">
                                <div class="testimony-wrap d-flex">
                                    <div class="user-img mr-4" style="background-image: url(CLIENTE_ACTIVOS/images/teacher-4.jpg)">
                                    </div>
                                    <div class="text ml-2 bg-light">
                                        <span class="quote d-flex align-items-center justify-content-center">
                                            <i class="icon-quote-left"></i>
        ...
        <section class="ftco-section ftco-consult ftco-no-pt ftco-no-pb" style="background-image: url(CLIENTE_ACTIVOS/images/bg_5.jpg);" data-stellar-background-ratio="0.5">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="pricing-entry bg-light pb-4 text-center">
                            ...
                            <div class="img" style="background-image: url(CLIENTE_ACTIVOS/images/bg_1.jpg);"></div>
                            <div class="px-4">
                                <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="pricing-entry bg-light pb-4 text-center">
                            ...
                            <div class="img" style="background-image: url(CLIENTE_ACTIVOS/images/bg_2.jpg);"></div>
                            <div class="px-4">
                                <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="pricing-entry bg-light active pb-4 text-center">
                            ...
                            <div class="img" style="background-image: url(CLIENTE_ACTIVOS/images/bg_3.jpg);"></div>
                            <div class="px-4">
                                <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="pricing-entry bg-light pb-4 text-center">
                            ...
                            <div class="img" style="background-image: url(CLIENTE_ACTIVOS/images/bg_5.jpg);"></div>
                            <div class="px-4">
                                <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4 ftco-animate">
                        <div class="blog-entry">
                            <a href="blog-single.php" class="block-20 d-flex align-items-end" style="background-image: url('CLIENTE_ACTIVOS/images/image_1.jpg');">
                    ...
                    <div class="col-md-6 col-lg-4 ftco-animate">
                        <div class="blog-entry">
                            <a href="blog-single.php" class="block-20 d-flex align-items-end" style="background-image: url('CLIENTE_ACTIVOS/images/image_2.jpg');">
                                <div class="meta-date text-center p-2">
                                    <span class="day">27</span>
                                    <span class="mos">January</span>
                                    <span class="yr">2019</span>
                    ...
                    <div class="col-md-6 col-lg-4 ftco-animate">
                        <div class="blog-entry">
                            <a href="blog-single.php" class="block-20 d-flex align-items-end" style="background-image: url('CLIENTE_ACTIVOS/images/image_3.jpg');">
                                <div class="meta-date text-center p-2">
                                    <span class="day">27</span>
                                    <span class="mos">January</span>
                                    <span class="yr">2019</span>
            ...
            <div class="container-wrap">
                <div class="row no-gutters">
                    <div class="col-md-3 ftco-animate">
                        <a href="CLIENTE_ACTIVOS/images/image_1.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(images/course-1.jpg);">
                    ...
                    <div class="col-md-3 ftco-animate">
                        <a href="CLIENTE_ACTIVOS/images/image_2.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(images/image_2.jpg);">
                            <div class="icon mb-4 d-flex align-items-center justify-content-center">
                                <span class="icon-instagram"></span>
                            </div>
                        </a>
                    ...
                    <div class="col-md-3 ftco-animate">
                        <a href="CLIENTE_ACTIVOS/images/image_3.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(images/image_3.jpg);">
                            <div class="icon mb-4 d-flex align-items-center justify-content-center">
                                <span class="icon-instagram"></span>
                            </div>
                        </a>
                    ...
                    <div class="col-md-3 ftco-animate">
                        <a href="CLIENTE_ACTIVOS/images/image_4.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(images/image_4.jpg);">
                            <div class="icon mb-4 d-flex align-items-center justify-content-center">
                                <span class="icon-instagram"></span>
                            </div>
                        </a>
        ...
        <!-- modal consulta-->
        <div class="modal fade" id="modal-consulta" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <span id="carregando1" style="display: none;">
                            <img src="ACTIVOS/img/theme/load.gif" style="height: 30px; width: 30px;"/></span> &nbsp;
                        <h5 class="modal-title" id="exampleModalLabel" style="font-family: arial;">Consultar estudante</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form class="" action="" method="POST" id="form_consulta">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><span style="color: red">*</span> Escola</label>
                                        <input type="text" class="form-control" name="codigo" placeholder="na004578" required=""/>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label><span style="color: red">*</span> Nº</label>
                                        <input type="number" class="form-control" name="n_estudante" placeholder="005441" required=""/>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label><span style="color: red">*</span> Ano</label>
                                        <input type="number" class="form-control" name="ano_lectivo" placeholder="Ano" required="" value="<?php echo date("Y"); ?>"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        <button type="submit" name="bt_consultar" class="btn btn-success">
                                            <span class="rotulo">GO</span>
                        ...
                        <div class="row">
                            <div class="col-md-12" id="carregar_notas">
