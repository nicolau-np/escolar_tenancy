            ...
            <tbody>
                <tr>
                    ...
                    foreach ($_SESSION["favoritosBO"] as $key => $value) {
                        ...
                        ?>
                        <td class="<?php if ($resNot->rowCount() >= 1): echo $objEstilos->nota_qualitativa($viewNot->mac);
            endif;
            ?>">

                            <?php
                            if ($resNot->rowCount() >= 1): if ($viewNot->mac != ""):echo $objEstilos->getEstado();
                                else: echo "---";
                                endif;
                            else: echo"---";
                            endif;
        ...
        <?php } ?>
                ...
                <tr>
                    ...
                    foreach ($_SESSION["favoritosBO"] as $key => $value) {
                        ...
                        ?>
                        <td class="<?php if ($resNot2->rowCount() >= 1): echo $objEstilos->nota_qualitativa($viewNot2->cpp);
                        endif;
                        ?>">

                             <?php
                            if ($resNot2->rowCount() >= 1): if ($viewNot2->data_lancamento != ""):echo $objEstilos->getEstado();
                                else: echo "---";
                                endif;
                            else: echo"---";
                            endif;
        ...
        <?php } ?>
                ...
                <tr>
                    ...
                    foreach ($_SESSION["favoritosBO"] as $key => $value) {
                        ...
                        ?>
                        <td class="<?php if ($resNot3->rowCount() >= 1): echo $objEstilos->nota_qualitativa($viewNot3->ct);
                endif;
                        ?>">

                            <?php
                            if ($resNot3->rowCount() >= 1): if ($viewNot3->ct != ""):echo $objEstilos->getEstado();
                                else: echo "---";
                                endif;
                            else: echo"---";
                            endif;
