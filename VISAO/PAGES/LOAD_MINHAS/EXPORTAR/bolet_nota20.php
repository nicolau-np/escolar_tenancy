            ...
            <tbody>
                <tr>
                    ...
                    foreach ($_SESSION["favoritosBO"] as $key => $value) {
                        ...
                        ?>
                        <td class="<?php if ($resNot->rowCount() >= 1): echo $objEstilos->nota20($viewNot->mac);
            endif;
            ?>">
        ...
        <?php } ?>
                ...
                <tr>
                    ...
                    foreach ($_SESSION["favoritosBO"] as $key => $value) {
                        ...
                        ?>
                        <td class="<?php if ($resNot2->rowCount() >= 1): echo $objEstilos->nota20($viewNot2->cpp);
                        endif;
                        ?>">
        ...
        <?php } ?>
                ...
                <tr>
                    ...
                    foreach ($_SESSION["favoritosBO"] as $key => $value) {
                        ...
                        ?>
                        <td class="<?php if ($resNot3->rowCount() >= 1): echo $objEstilos->nota20($viewNot3->ct);
                endif;
                        ?>">
