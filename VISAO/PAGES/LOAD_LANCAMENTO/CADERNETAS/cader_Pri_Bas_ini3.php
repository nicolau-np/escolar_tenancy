...
<div class="pagina">
    ...
    <div class="classificacoes" style="font-family:arial; font-size: 13px; border: 1px #4d7bca dotted; padding: 3px;">
        <span style="background:#EF3159; color: #fff; padding: 4px; border-radius: 15px;">(1 - 2) MAU</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <span style="background:#b37400; color: #fff; padding: 4px; border-radius: 15px;">(3 - 4) MEDÍUQUE</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <span style="background:#ffd600;; color: #fff; padding: 4px; border-radius: 15px;">(5 - 6) SÚFICE</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <span style="background:#2dce89; color: #fff; padding: 4px; border-radius: 15px;">(7 - 8) BOM</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <span style="background:#4d7bca; color: #fff; padding: 4px; border-radius: 15px;">(9 - 10) MUITO BOM</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
