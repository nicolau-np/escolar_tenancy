    ...
    $(document).ready(function () {
        ...
        $("#cader_1").click(function (e) {
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    $("#modal-carregamento").modal("hide");
                    $("#carregar_trimestres1").load("LOAD_LANCAMENTO/CADERNETAS/carrega_notas1.php");
                }
            });
            return false;
        });
        ...
        $("#cader_2").click(function (e) {
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    $("#modal-carregamento").modal("hide");
                    $("#carregar_trimestres2").load("LOAD_LANCAMENTO/CADERNETAS/carrega_notas2.php");
                }
            });
            return false;
        });
        ...
        $("#cader_3").click(function (e) {
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    $("#modal-carregamento").modal("hide");
                    $("#carregar_trimestres3").load("LOAD_LANCAMENTO/CADERNETAS/carrega_notas3.php");
                }
            });
            return false;
        });
                    ...
                    <div class="col-md-3">
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush" id="tblEditavel1P">
                                <thead class="thead-light">
                                <tr>
                                    <th style="visibility: hidden;" title="id_prova" scope="col" style="width: 4%;"
                                        rowspan="2">---
                                    </th>
