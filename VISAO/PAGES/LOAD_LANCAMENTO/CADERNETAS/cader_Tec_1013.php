    ...
    $(document).ready(function () {
        ...
        $("#cader_1").click(function (e) {
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    $("#modal-carregamento").modal("hide");
                    $("#carregar_trimestres1").load("LOAD_LANCAMENTO/CADERNETAS/carrega_notas1T.php");
                }
            });
            return false;
        });
        ...
        $("#cader_2").click(function (e) {
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    $("#modal-carregamento").modal("hide");
                    $("#carregar_trimestres2").load("LOAD_LANCAMENTO/CADERNETAS/carrega_notas2T.php");
                }
            });
            return false;
        });
        ...
        $("#cader_3").click(function (e) {
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    $("#modal-carregamento").modal("hide");
                    $("#carregar_trimestres3").load("LOAD_LANCAMENTO/CADERNETAS/carrega_notas3T.php");
                }
            });
            return false;
        });
    ...
    <div class="tabs-container">
        ...
        <?php if ($data_bloqueio['trimestre1'] != "off"): ?>
            <div id="tab-1" class="tab-content current">
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-right"><a href='#' id="cader_1"><i class="fa fa-plus-square"
                                    ...
                                    <tr>
                                        ...
                                        <td title="valor2">
                                            <input type="number"
                                                   data-id_avaliacao="<?php echo $view1P->id_prova; ?>"
                                                   style="width: 50px;"
                                                   value="<?php if ($view1P->valor2 != ""): echo $view1P->valor2; else: echo "---"; endif; ?>"
                                                   data-coluna="2" data-id_prova="<?php echo $view1P->id_prova; ?>"
                                                   class="prova"/>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
        ...
        <?php if ($data_bloqueio['trimestre2'] != "off"): ?>
            <div id="tab-2" class="tab-content">
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-right"><a href='#' id="cader_2"><i class="fa fa-plus-square"
                                                                            style="cursor:pointer;"></i></a></div>
                    </div>
                </div>
                    ...
                    <div class="col-md-9">
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush" id="tblEditavel2A">
                                <thead class="thead-light">
                                <tr>
                                    <th title="id_avaliacao" scope="col" style="width: 4%;" rowspan="2">Nº
                                    </th>
                                    <th title="nome_estudante" scope="col" rowspan="2">Nome estudante</th>
                                    <th colspan="3" style="text-align:center;">Avaliações</th>
                                </tr>
        ...
        <?php if ($data_bloqueio['trimestre3'] != "off"): ?>
            <div id="tab-3" class="tab-content">
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-right"><a href='#' id="cader_3"><i class="fa fa-plus-square"
                                                                            style="cursor:pointer;"></i></a></div>
                    </div>
                </div>
                    ...
                    <div class="col-md-9">
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush" id="tblEditavel3A">
                                <thead class="thead-light">
                                <tr>
                                    <th title="id_avaliacao" scope="col" style="width: 4%;"
                                        rowspan="2">Nº
                                    </th>
                                    <th title="nome_estudante" scope="col" rowspan="2">Nome estudante</th>
                                    <th colspan="3" style="text-align:center;">Avaliações</th>
                            ...
                            <table class="table align-items-center table-flush" id="tblEditavel3P">
                                ...
                                while ($view3P = $res3P->fetch(PDO::FETCH_OBJ)):
                                    ...
                                    <tr>
                                        <td title="valor1">
                                            <input type="number"
                                                   data-id_avaliacao="<?php echo $view3P->id_prova; ?>"
                                                   style="width: 50px;"
                                                   value="<?php if ($view3P->valor1 != ""): echo $view3P->valor1; else: echo "---"; endif; ?>"
                                                   data-coluna="1" data-id_prova="<?php echo $view3P->id_prova; ?>"
                                                   class="prova"/>
                                        </td>
                                        ...
                                        <td title="valor2">
                                            <input type="number"
                                                   data-id_avaliacao="<?php echo $view3P->id_prova; ?>"
                                                   style="width: 50px;"
                                                   value="<?php if ($view3P->valor2 != ""): echo $view3P->valor2; else: echo "---"; endif; ?>"
                                                   data-coluna="2" data-id_prova="<?php echo $view3P->id_prova; ?>"
                                                   class="prova"/>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                    ...
                    <div class="col-md-9">
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush" id="tblEditavelCPE">
                                <thead class="thead-light">
                                <tr>
                                    <th title="id_notasfinais" scope="col" style="width: 4%;">Nº
                                    </th>
