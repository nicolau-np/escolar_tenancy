...
<script>
    $(document).ready(function () {
        ...
        $("#estatistic").click(function(e){
            ...
            jQuery.ajax({
                type: "POST",
                url: "LOAD_MINIPAUTAS/ESTATISTICAS/esta_Pri_Bas_10Quant.php",
                data: {pagina:"mini_Pri_Bas_24.php"},
    ...
    <div class="row" style="font-family: arial; font-size: 13px;"> 
        ...
        <div class="col-md-10">
         ...
         <div class="col-md-1">
            ...
            <a href="LOAD_MINIPAUTAS/MINI_PAUTA/mini_Pri_Bas_24_export.php" id="exportar" title="Exportar"><i class="fa fa-file-excel"></i></a>
            &nbsp;&nbsp;
