...
<div class="pagina">
    ...
    <table class="table align-items-center table-flush" border="1" style="font-family:arial; font-size: 13px;">
        <thead class="thead-light">
            <tr>
                <th colspan="14">MINI PAUTA DISCIPLINA: <?php echo $_SESSION['nome_disciplinaM']; ?>&nbsp;&nbsp; TURMA: <?php echo $_SESSION['turmaM']; ?> &nbsp;&nbsp; ANO: <?php echo $objGlobals->getAno_lectivo(); ?></th>
            </tr>
            <tr>
        ...
        <tbody>
            ...
            while ($viewEs = $resEs->fetch(PDO::FETCH_OBJ)):
                ...
                <tr>
                    ...
                    <!-- 1 trimestre-->
                    <td class="<?php if ($res1->rowCount() >= 1): echo $objEstilos->nota_qualitativa($view1->mac);
                    endif; ?>">
                        <?php
                    ...
                    <td class="<?php if ($res1->rowCount() >= 1): echo $objEstilos->nota_qualitativa($view1->cpp);
                    endif; ?>">
                        <?php
                    ...
                    <td class="<?php if ($res1->rowCount() >= 1): echo $objEstilos->nota_qualitativa($view1->ct);
                    endif; ?>">
                        <?php
                    ...
                    <!-- 2 trimestre-->
                    <td class="<?php if ($res2->rowCount() >= 1): echo $objEstilos->nota_qualitativa($view2->mac);
                        endif; ?>">
                        <?php
                    ...
                    <td class="<?php if ($res2->rowCount() >= 1): echo $objEstilos->nota_qualitativa($view2->cpp);
                    endif; ?>">
    <?php
    ...
    ?>
                    ...
                    <td class="<?php if ($res2->rowCount() >= 1): echo $objEstilos->nota_qualitativa($view2->ct);
                    endif; ?>">
                        <?php
                    ...
                    <!-- 3 trimestre-->
                    <td class="<?php if ($res3->rowCount() >= 1): echo $objEstilos->nota_qualitativa($view3->mac);
                    endif; ?>">
    <?php
    ...
    ?>
                    ...
                    <td class="<?php if ($res3->rowCount() >= 1): echo $objEstilos->nota_qualitativa($view3->cpp);
                    endif; ?>">
                        <?php
                    ...
                    <td class="<?php if ($res3->rowCount() >= 1): echo $objEstilos->nota_qualitativa($view3->ct);
                        endif; ?>">
    <?php
    ...
    ?>
                    ...
                    <!-- finais-->
                    <td class="<?php if ($resFi->rowCount() >= 1): echo $objEstilos->nota_qualitativa($viewFi->cap);
    endif; ?>">
    <?php
    ...
    ?>
                    ...
                    <td class="<?php if ($resFi->rowCount() >= 1): echo $objEstilos->nota_qualitativa($viewFi->cf);
    endif; ?>">
    <?php
