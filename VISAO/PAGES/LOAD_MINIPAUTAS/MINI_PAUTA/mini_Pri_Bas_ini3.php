...
<script>
    $(document).ready(function () {
        ...
        $("#estatistic").click(function(e){
            ...
            jQuery.ajax({
                type: "POST",
                url: "LOAD_MINIPAUTAS/ESTATISTICAS/esta_Pri_Bas_10Quali.php",
                data: {pagina:"mini_Pri_Bas_ini3.php"},
    ...
    <div class="row" style="font-family: arial; font-size: 13px;"> 
        ...
        <div class="col-md-10">
         ...
         <div class="col-md-1">
            ...
            <a href="LOAD_MINIPAUTAS/MINI_PAUTA/mini_Pri_Bas_ini3_export.php" id="exportar" title="Exportar"><i class="fa fa-file-excel"></i></a>
            &nbsp;&nbsp;
                ...
                <table class="table align-items-center table-flush">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th colspan="2" style="text-align:center;">Dados Finais</th>
                        </tr>
                        <tr>
                    ...
                    <tbody>
                        ...
                        while ($viewEs = $resEs->fetch(PDO::FETCH_OBJ)):
                            ...
                            <!-- 1 trimestre-->
                                <td class="<?php if($res1->rowCount()>=1): echo $objEstilos->nota_qualitativa($view1->mac); endif; ?>">
                                    <?php
                                    if($res1->rowCount()>=1): if ($view1->mac != ""):echo $objEstilos->getEstado();
                                    else: echo "---";
                                    endif; else: echo"---";endif;
                                    ?>
                                </td>
                                  <td class="<?php if($res1->rowCount()>=1): echo $objEstilos->nota_qualitativa($view1->cpp); endif; ?>">
                                    <?php
                                    if($res1->rowCount()>=1): if ($view1->data_lancamento != ""):echo $objEstilos->getEstado();
                                    else: echo "---";
                                    endif; else: echo"---";endif;
                                    ?>
                                </td>
                               <td class="<?php if($res1->rowCount()>=1): echo $objEstilos->nota_qualitativa($view1->ct); endif; ?>">
                                    <?php
                                    if($res1->rowCount()>=1): if ($view1->ct != ""):echo $objEstilos->getEstado();
                                    else: echo "---";
                                    endif; else: echo"---";endif;
                                    ?>
                                </td>
                                <!-- 2 trimestre-->
                                <td class="<?php if($res2->rowCount()>=1): echo $objEstilos->nota_qualitativa($view2->mac); endif; ?>">
                                    <?php
                                    if($res2->rowCount()>=1): if ($view2->mac != ""):echo $objEstilos->getEstado();
                                    else: echo "---";
                                    endif; else: echo"---";endif;
                                    ?>
                                </td>
                                  <td class="<?php if($res2->rowCount()>=1): echo $objEstilos->nota_qualitativa($view2->cpp); endif; ?>">
                                    <?php
                                    if($res2->rowCount()>=1): if ($view2->data_lancamento != ""):echo $objEstilos->getEstado();
                                    else: echo "---";
                                    endif; else: echo"---";endif;
                                    ?>
                                </td>
                               <td class="<?php if($res2->rowCount()>=1): echo $objEstilos->nota_qualitativa($view2->ct); endif; ?>">
                                    <?php
                                    if($res2->rowCount()>=1): if ($view2->ct != ""):echo $objEstilos->getEstado();
                                    else: echo "---";
                                    endif; else: echo"---";endif;
                                    ?>
                                </td>
                                <!-- 3 trimestre-->
                                <td class="<?php if($res3->rowCount()>=1): echo $objEstilos->nota_qualitativa($view3->mac); endif; ?>">
                                    <?php
                                    if($res3->rowCount()>=1): if ($view3->mac != ""):echo $objEstilos->getEstado();
                                    else: echo "---";
                                    endif; else: echo"---";endif;
                                    ?>
                                </td>
                                  <td class="<?php if($res3->rowCount()>=1): echo $objEstilos->nota_qualitativa($view3->cpp); endif; ?>">
                                    <?php
                                    if($res3->rowCount()>=1): if ($view2->data_lancamento != ""):echo $objEstilos->getEstado();
                                    else: echo "---";
                                    endif; else: echo"---";endif;
                                    ?>
                                </td>
                               <td class="<?php if($res3->rowCount()>=1): echo $objEstilos->nota_qualitativa($view3->ct); endif; ?>">
                                    <?php
                                    if($res3->rowCount()>=1): if ($view3->ct != ""):echo $objEstilos->getEstado();
                                    else: echo "---";
                                    endif; else: echo"---";endif;
                                    ?>
                                </td>
                                <!-- finais-->
                                <td class="<?php if($resFi->rowCount()>=1): echo $objEstilos->nota_qualitativa($viewFi->cap); endif; ?>">
                                    <?php
                                    if($resFi->rowCount()>=1): if ($viewFi->cap != ""):echo $objEstilos->getEstado();
                                    else: echo "---";
                                    endif; else: echo"---";endif;
                                    ?>
                                </td>
                               
                               <td class="<?php if($resFi->rowCount()>=1): echo $objEstilos->nota_qualitativa($viewFi->cf); endif; ?>">
                                    <?php
                                    if($resFi->rowCount()>=1): if ($viewFi->cf != ""):echo $objEstilos->getEstado();
                                    else: echo "---";
                                    endif; else: echo"---";endif;
                                    ?>
                                </td>
