    ...
    <div class="row" style="font-family: arial; font-size: 13px;"> 
        ...
        <div class="col-md-10">
         ...
         <div class="col-md-1">
            ...
            <a href="LOAD_MINIPAUTAS/MINI_PAUTA/mini_Sec_1013_export.php" id="exportar" title="Exportar"><i class="fa fa-file-excel"></i></a>
            &nbsp;&nbsp;
                ...
                <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                        ...
                        while ($viewEs = $resEs->fetch(PDO::FETCH_OBJ)):
                            ...
                            <!-- 1 trimestre-->
                                <td class="<?php if($res1->rowCount()>=1): echo $objEstilos->nota20($view1->mac); endif; ?>">
                                    <?php
                                  ...
                                  <td class="<?php if($res1->rowCount()>=1): echo $objEstilos->nota20($view1->cpp); endif; ?>">
                                    <?php
                               ...
                               <td class="<?php if($res1->rowCount()>=1): echo $objEstilos->nota20($view1->ct); endif; ?>">
                                    <?php
                                ...
                                <!-- 2 trimestre-->
                                <td class="<?php if($res2->rowCount()>=1): echo $objEstilos->nota20($view2->mac); endif; ?>">
                                    <?php
                                  ...
                                  <td class="<?php if($res2->rowCount()>=1): echo $objEstilos->nota20($view2->cpp); endif; ?>">
                                    <?php
                               ...
                               <td class="<?php if($res2->rowCount()>=1): echo $objEstilos->nota20($view2->ct); endif; ?>">
                                    <?php
                                ...
                                <!-- 3 trimestre-->
                                <td class="<?php if($res3->rowCount()>=1): echo $objEstilos->nota20($view3->mac); endif; ?>">
                                    <?php
                                  ...
                                  <td class="<?php if($res3->rowCount()>=1): echo $objEstilos->nota20($view3->cpp); endif; ?>">
                                    <?php
                               ...
                               <td class="<?php if($res3->rowCount()>=1): echo $objEstilos->nota20($view3->ct); endif; ?>">
                                    <?php
