    ...
    <head>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#carrega_cadastro").load("LOAD_CADASTRO/usuarios.php", function () {
                ...
                $("#docentes").click(function (e) {
                    e.preventDefault();
                    $("#modal-carregamento").modal("show");
                    $("#carrega_cadastro").load("LOAD_CADASTRO/funcionarios.php", function () {
                        $("#modal-carregamento").modal("hide");
                    });
                });

                $("#estudantes").click(function (e) {
                    e.preventDefault();
                    $("#modal-carregamento").modal("show");
                    $("#carrega_cadastro").load("LOAD_CADASTRO/estudantes.php", function () {
                        $("#modal-carregamento").modal("hide");
                    });
                });
                ...
                $("#horario").click(function (e) {
                    e.preventDefault();
                    $("#modal-carregamento").modal("show");
                    $("#carrega_cadastro").load("LOAD_CADASTRO/horarios.php", function () {
                        $("#modal-carregamento").modal("hide");
                    });
                });
    ...
    <body class="">
        ...
        <div class="main-content">
            ...
            <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
                <div class="container-fluid">
                    <!-- Brand -->
                    <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="icons.php">Cadastro</a>
                    <!-- Form -->
                                        ...
                                        <a href="#" id="admin"> 
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <span class="h2 font-weight-bold mb-0"><?php echo $res->rowCount();?></span>
                                                </div>
                                                <div class="col-auto">
                                ...
                                <div class="card card-stats mb-4 mb-xl-0">
                                    <div class="card-body">
                                        <a href="#" id="horario">
                                            <div class="row">
                                                <div class="col">
                                                    <h5 class="card-title text-uppercase text-muted mb-0">Horários</h5>
