    ...
    <head>
        ...
        <script type="text/javascript" src="../../ACTIVOS/js/jquery-1.5.2.js"></script>
            ...
            $(document).ready(function(){
                ...
                $("#carregar_relatorio").load("LOAD_RELATORIOS/relatorios_prof.php", function () {
                    $("#modal-carregamento").modal("hide");
                });
                
                $("#rel_professor").click(function(){
                    $("#modal-carregamento").modal("show");
                    $("#carregar_relatorio").load("LOAD_RELATORIOS/relatorios_prof.php", function(){
                       $("#modal-carregamento").modal("hide"); 
                    });
    ...
    <body class="">
        ...
        <div class="main-content">
            ...
            <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
                <div class="container-fluid">
                    <!-- Brand -->
                    <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="tables.php">Relatórios</a>
                    <!-- Form -->
                ...
                <div class="row">
                    <div class="col">
                        <div class="card shadow">
                          ...
                          <div class="card-body" id="carregar_relatorio">
