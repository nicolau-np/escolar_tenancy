    ...
    <div class="row" style="font-family: arial; font-size: 13px;"> 
        ...
        <div class="col-md-1">
            <div class="text-right">
                <a href="LOAD_PAUTAS/PAUTAS/simples/paut_Pri_Bas_ini3_export.php" id="export" title="Exportar"><i class="fa fa-file-excel"></i></a>
            </div>
        </div>
    </div>
    <hr/>
                    ...
                    <thead class="thead-light">
                        <tr>
                            ...
                            foreach ($_SESSION["favoritosPA"] as $key => $value) {
                                ...
                                <th colspan="2"><?php echo $viewDis->sigla; ?></th>
                                <?php
                            }
                            ?>
                        </tr>
