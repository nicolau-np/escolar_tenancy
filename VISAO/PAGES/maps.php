    ...
    <head>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#carrega_lancamento").load("LOAD_LANCAMENTO/notas.php", function () {
                ...
                $("#faltas").click(function (e) {
                    e.preventDefault();
                    $("#modal-carregamento").modal("show");
                    $("#carrega_lancamento").load("LOAD_LANCAMENTO/faltas.php", function () {
                        $("#modal-carregamento").modal("hide");
                    });
                });
    ...
    <body class="">
        ...
        <div class="main-content">
            ...
            <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
                <div class="container-fluid">
                    <!-- Brand -->
                    <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="maps.php">Lançamentos</a>
                    <!-- Form -->
                ...
                <div class="row">
                    <div class="col">
                        <div class="card shadow">
                            ...
                            <div class="card-body" id="carrega_lancamento">
