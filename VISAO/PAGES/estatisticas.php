    ...
    <head>
        ...
        $(document).ready(function(){
           $("#modal-carregamento").modal("show");
                $("#carregar_estatisticas").load("LOAD_ESTATISTICA/est_turmas.php", function () {
                    $("#modal-carregamento").modal("hide");
                });
                
                $("#est_turmas").click(function(){
                    $("#modal-carregamento").modal("show");
                $("#carregar_estatisticas").load("LOAD_ESTATISTICA/est_turmas.php", function () {
                    $("#modal-carregamento").modal("hide");
                });
                 ...
                 $("#est_disciplinas").click(function(){
                    $("#modal-carregamento").modal("show");
                $("#carregar_estatisticas").load("LOAD_ESTATISTICA/est_disciplinas.php", function () {
                    $("#modal-carregamento").modal("hide");
                });
                });
                
                 $("#est_professores").click(function(){
                    $("#modal-carregamento").modal("show");
                $("#carregar_estatisticas").load("LOAD_ESTATISTICA/est_professores.php", function () {
                    $("#modal-carregamento").modal("hide");
                });
                });
                
                 $("#est_estudantes").click(function(){
                    $("#modal-carregamento").modal("show");
                $("#carregar_estatisticas").load("LOAD_ESTATISTICA/est_estudantes.php", function () {
                    $("#modal-carregamento").modal("hide");
                });
                });
    ...
    <body class="">
        ...
        <div class="main-content">
            ...
            <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
                <div class="container-fluid">
                    <!-- Brand -->
                    <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="estatisticas.php">Estatística</a>
                    <!-- Form -->
                ...
                <div class="row">
                    <div class="col">
                        <div class="card shadow">
                            <div class="card-body" id="carregar_estatisticas">
