...
$res2 = $objTurmaDAO->buscaTurmas();
$res3 = $objDisciplinasDAO->buscarDisciplinas();
    ...
    <head>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#carrega_cadastro").load("LOAD_INSTITUCIONAL/cursos.php", function () {
                ...
                $("#turmas").click(function (e) {
                    e.preventDefault();
                    $("#modal-carregamento").modal("show");
                    $("#carrega_cadastro").load("LOAD_INSTITUCIONAL/turmas.php", function () {
                        $("#modal-carregamento").modal("hide");
                    });
                });
                $("#disciplinas").click(function (e) {
                    e.preventDefault();
                    $("#modal-carregamento").modal("show");
                    $("#carrega_cadastro").load("LOAD_INSTITUCIONAL/disciplinas.php", function () {
                        $("#modal-carregamento").modal("hide");
                    });
                });
                $("#salas").click(function (e) {
                    e.preventDefault();
                    $("#modal-carregamento").modal("show");
                    $("#carrega_cadastro").load("LOAD_INSTITUCIONAL/salas.php", function () {
                        $("#modal-carregamento").modal("hide");
                    });
                });
            });
    ...
    <body class="">
        ...
        <div class="main-content">
            ...
            <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
                <div class="container-fluid">
                    <!-- Brand -->
                    <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="institucional.php">Institucional</a>
                    <!-- Form -->
                    ...
                    <div class="header-body">
                        ...
                        <div class="row">
                                        ...
                                        <a href="#" id="cursos"> 
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <span class="h2 font-weight-bold mb-0"><?php echo $res1->rowCount(); ?></span>
                                                </div>
                                                <div class="col-auto">
                                ...
                                <div class="card card-stats mb-4 mb-xl-0">
                                    <div class="card-body">
                                        <a href="#" id="turmas">
                                            <div class="row">
                                                <div class="col">
                                                    <h5 class="card-title text-uppercase text-muted mb-0">Turmas</h5>
                                                    <span class="h2 font-weight-bold mb-0"><?php echo $res2->rowCount(); ?></span>
                                                </div>
                                                <div class="col-auto">
                            ...
                            <div class="col-xl-3 col-lg-6">
                                <div class="card card-stats mb-4 mb-xl-0">
                                    <div class="card-body">
                                        <a href="#" id="disciplinas">
                                            <div class="row">
                                                <div class="col">
                                                    <h5 class="card-title text-uppercase text-muted mb-0">Disciplinas</h5>
                                                    <span class="h2 font-weight-bold mb-0"><?php echo $res3->rowCount(); ?></span>
                                                </div>
                                                <div class="col-auto">
                                        ...
                                        <a href="#" id="salas">
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <span class="h2 font-weight-bold mb-0"><i class="fas fa-arrow-up"></i></span>
                                                </div>
                                                <div class="col-auto">
                ...
                <div class="row">
                    <div class="col">
                        <div class="card shadow">
                            ...
                            <div class="card-body" id="carrega_cadastro">
        ...
        <!--   Optional JS   -->
        <script src="../../ACTIVOS/js/plugins/clipboard/dist/clipboard.min.js"></script>
        <!--   Argon JS   -->
