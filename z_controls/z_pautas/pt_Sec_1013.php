        ...
        <tbody>
            ...
            while ($view3 = $res3->fetch(PDO::FETCH_OBJ)):
                ...
                <tr>
                    ...
                    <!-- primeiro trimestre-->
                    <td class="<?php
                    if ($res4->rowCount() >= 1): echo $objEstilos->nota20($view4->mac);
                    endif;
                    ?>">
                            <?php
                     ...
                     <td class="<?php
                    if ($res4->rowCount() >= 1): echo $objEstilos->nota20($view4->cpp);
                    endif;
                    ?>">
                            <?php
                     ...
                     <td class="<?php
                    if ($res4->rowCount() >= 1): echo $objEstilos->nota20($view4->ct);
                    endif;
                    ?>">
                            <?php
                   ...
                   <!-- segundo trimestre-->
                    <td class="<?php
                    if ($res5->rowCount() >= 1): echo $objEstilos->nota20($view5->mac);
                    endif;
                    ?>">
                            <?php
                     ...
                     <td class="<?php
                    if ($res5->rowCount() >= 1): echo $objEstilos->nota20($view5->cpp);
                    endif;
                    ?>">
                            <?php
                     ...
                     <td class="<?php
                    if ($res5->rowCount() >= 1): echo $objEstilos->nota20($view5->ct);
                    endif;
                    ?>">
                            <?php
                    ...
                    <!--fim-->
                            ...
                            <!-- terceiro trimestre-->
                    <td class="<?php
                    if ($res6->rowCount() >= 1): echo $objEstilos->nota20($view6->mac);
                    endif;
                    ?>">
                            <?php
                     ...
                     <td class="<?php
                    if ($res6->rowCount() >= 1): echo $objEstilos->nota20($view6->cpp);
                    endif;
                    ?>">
                            <?php
                     ...
                     <td class="<?php
                    if ($res6->rowCount() >= 1): echo $objEstilos->nota20($view6->ct);
                    endif;
                    ?>">
                            <?php
                    ...
                    <!--fim-->
                                  ...
                                  <!-- final-->
                    <td class="<?php
                    if ($resFi->rowCount() >= 1): echo $objEstilos->nota20($viewFi->cap);
                    endif;
                    ?>">
                            <?php
                     ...
                     <td class="<?php
                    if ($resFi->rowCount() >= 1): echo $objEstilos->nota20($viewFi->cpe);
                    endif;
                    ?>">
                            <?php
                     ...
                     <td class="<?php
                    if ($resFi->rowCount() >= 1): echo $objEstilos->nota20($viewFi->cf);
                    endif;
                    ?>">
                            <?php
